...
| Suite | Cases | Tags |
| --- | ---: | --- |
| [Go AGN CLI](../suites/go-agn-cli.md) | 7 | @svc_agn_cli |
| [Go Core](../suites/go-core.md) | 94 | @svc_agents_orchestrator, @svc_runners, @svc_metering, @svc_k8s_runner, @svc_organizations, @svc_files, @svc_gateway, @svc_egress, @svc_egress_gateway, @svc_media_proxy, @svc_llm, @svc_llm_proxy, @smoke |
| [Go Terraform Provider](../suites/go-terraform.md) | 47 | @svc_gateway, @tf_provider_agyn |
| [Playwright Console App](../suites/playwright.md) | 45 | @svc_console, @svc_gateway, @svc_threads, @svc_metering, @svc_identity, @smoke |
