...
Exercises the released or supplied `agn` CLI against the platform, focusing on command execution, session persistence, resume behavior, tool-pair summarization, and system-prompt behavior.
