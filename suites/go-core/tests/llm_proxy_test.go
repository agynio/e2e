...
func TestLLMGatewayConnectEndpointPath(t *testing.T) {
	t.Setenv(gatewayBaseURLEnvKey, "http://gateway.agyn-platform.svc.cluster.local:8080")

	require.Equal(
		t,
		"http://gateway.agyn-platform.svc.cluster.local:8080/agynio.api.gateway.v1.LLMGateway/CreateLLMProvider",
