...
const (
	...
	ZitiManagementService_CreateSandboxIdentity_FullMethodName       = "/agynio.api.ziti_management.v1.ZitiManagementService/CreateSandboxIdentity"
...
type ZitiManagementServiceClient interface {
	...
	CreateSandboxIdentity(ctx context.Context, in *CreateSandboxIdentityRequest, opts ...grpc.CallOption) (*CreateSandboxIdentityResponse, error)
...
func (c *zitiManagementServiceClient) CreateSandboxIdentity(ctx context.Context, in *CreateSandboxIdentityRequest, opts ...grpc.CallOption) (*CreateSandboxIdentityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSandboxIdentityResponse)
	err := c.cc.Invoke(ctx, ZitiManagementService_CreateSandboxIdentity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ZitiManagementServiceServer interface {
	...
	// Orchestrator -> create OpenZiti identity for a sandbox workload, return enrollment JWT.
	CreateSandboxIdentity(context.Context, *CreateSandboxIdentityRequest) (*CreateSandboxIdentityResponse, error)
	// Apps Service -> create and enroll an OpenZiti identity for an app. If a previous
	// identity exists, deletes it first. Returns enrolled credentials.
...
func (UnimplementedZitiManagementServiceServer) CreateSandboxIdentity(context.Context, *CreateSandboxIdentityRequest) (*CreateSandboxIdentityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSandboxIdentity not implemented")
}
...
func _ZitiManagementService_CreateSandboxIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSandboxIdentityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ZitiManagementServiceServer).CreateSandboxIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZitiManagementService_CreateSandboxIdentity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZitiManagementServiceServer).CreateSandboxIdentity(ctx, req.(*CreateSandboxIdentityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ZitiManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateSandboxIdentity",
			Handler:    _ZitiManagementService_CreateSandboxIdentity_Handler,
		},
		{
